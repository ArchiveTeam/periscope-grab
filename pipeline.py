...
LUA_SHA1 = get_hash(os.path.join(CWD, 'periscope.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'id':
                wget_args.extend(['--warc-header', 'periscope-id: '+item_value])
                wget_args.append('https://www.pscp.tv/w/'+item_value)
            #elif item_type == 'user':
            else:
